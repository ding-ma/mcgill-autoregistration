...
4. Once deployed, create Google Cloud Scheduler that calls the url generated by the function. Recommended time is every 1h to not get banned from minerva, with this cron: `* 1 * * *`. \
